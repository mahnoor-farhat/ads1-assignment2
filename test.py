...
filename = r"C:\Users\SAAD COMMUNICATION\OneDrive\Desktop\population.csv"
...
filename = r"C:\Users\SAAD COMMUNICATION\OneDrive\Desktop\energy_consumption.csv"
...
def pop_line_graph():
    ...
    df = pd.read_csv(r"C:\Users\SAAD COMMUNICATION\OneDrive\Desktop\population.csv", skiprows=4)

    df_country1 = df[df['Country Name'] == 'Central African Republic']
    ...
    plt.plot(df_years1, df_values1.values.ravel(), label = 'Central African Republic')
...
def energy_line_graph():
    ...
    df = pd.read_csv(r"C:\Users\SAAD COMMUNICATION\OneDrive\Desktop\energy_consumption.csv", skiprows=4)
